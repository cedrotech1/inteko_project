                ...
                <div className="card-body">
                    ...
                    <div className="mb-3">
                        {comments.map((comment) => (
                            <div key={comment.id} className="media mb-3" style={{ backgroundColor: 'whitesmoke', margin: '0.3cm', padding: '0.2cm', borderRadius: '0.3cm' }}>
                                ...
                                <div className="row">
                                    <div className="col-1">
                                        <img
                                            ...
                                            style={{ width: "70px", height: "70px", marginTop: '0.2cm' }}
                                        />
