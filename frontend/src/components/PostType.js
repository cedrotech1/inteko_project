...
const CategoriesPage = () => {
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center mb-4" style={{ backgroundColor: "lightblue", border: "0px solid white", padding: "0.3cm", color: "black", borderRadius: "6px", textShadow: "" }}>
        ...
        <div className="col-md-6">
          <div className="card shadow-sm">
            <div className="card-body">
              ...
              <button className="btn btn-primary w-100" style={{ border: "1px solid lightblue", backgroundColor: "lightblue", color: "black", marginTop: "1cm", width: "80%" }} onClick={handleAddCategory}>
                Add Category
              </button>
